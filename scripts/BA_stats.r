...
base_dir <- "./data/burned_area_products/VNP64A1/TIFF" # Directory with burndate.tif files
gpk_path <- "./data/S2BAVG_grid/S2BAVG.gpkg"  # Input GeoPackage
output_gpkg <- "./outputs/S2BAVG_updates/S2BAVG_update.gpkg"  # Output GeoPackage
temp_dir     <- "./data/temp/mosaics"  # Temporary directory for mosaics
modis_crs_hdf <- "./data/crs_file/modis_crs.hdf"  # MODIS Sinusoidal CRS HDF file
